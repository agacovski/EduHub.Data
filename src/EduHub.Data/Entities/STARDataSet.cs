...
END");
        ...
        public override SqlCommand GetSqlDisableIndexesCommand(SqlConnection SqlConnection)
        {
            return new SqlCommand(
                connection: SqlConnection,
                cmdText:
@"IF EXISTS (SELECT * FROM dbo.sysindexes WHERE id = OBJECT_ID(N'[dbo].[STAR]') AND name = N'STAR_Index_TID')
    ALTER INDEX [STAR_Index_TID] ON [dbo].[STAR] DISABLE;
");
        }
        ...
        public override SqlCommand GetSqlRebuildIndexesCommand(SqlConnection SqlConnection)
        {
            return new SqlCommand(
                ...
                cmdText:
@"IF EXISTS (SELECT * FROM dbo.sysindexes WHERE id = OBJECT_ID(N'[dbo].[STAR]') AND name = N'STAR_Index_TID')
    ALTER INDEX [STAR_Index_TID] ON [dbo].[STAR] REBUILD PARTITION = ALL;
");
        }
